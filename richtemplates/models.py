...
class UserProfile(models.Model):
    """
    This class would be abstract if ``AUTH_PROFILE_MODULE`` is not equal
    to ``richtemplates.UserProfile`` (this class) as one may use his own,
    custom profile. If so, it is possible to simply extend this class
    or leave it at all.
    """
